...
public :
   ...
   bool AmuonPassedOhltCuts();
   bool DoubleMuonPassedRelaxedOhltCuts();
   bool AphotonPassedOhltCuts();
   bool AphotonPassedRelaxedOhltCuts();
   bool AelectronPassedOhltCuts();
   bool AelectronPassedRelaxedOhltCuts();
   bool AmuonPassedAptOhltCuts(double muonPt=-999, double  muonDr=-999, double muonIso=0);
   int  AelectronPassedAptOhltCuts(double Et=-999, double L1iso=0, double Tiso=999, double Hiso=999, double eoverpBR=999, double eoverpEC=999);
   int  AphotonPassedAptOhltCuts(double Et=-999, double L1iso=0, double Tiso=999, double Eiso=999, double HisoBR=999, double HisoEC=999);
   bool DoubleElectronPassedRelaxedOhltCuts();
	 bool isEgammaL1_ElectronSuperclusterMatched(int i);
	 bool isEgammaL1_PhotonSuperclusterMatched(int i);
	 bool HasL1jet(double Pt);
