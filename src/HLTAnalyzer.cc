...
void HLTAnalyzer::analyze(edm::Event const& iEvent, edm::EventSetup const& iSetup) {
  ...
  std::cout<<"a"<<std::endl;
    ...
    */
    ...
    if(_DoJets){
      std::cout<<"Running jets"<<std::endl;
    ...
    if(_DoMuons){
      std::cout<<"Running muons"<<std::endl;
    ...
    if(_DoPhotons || _DoSuperClusters){
      std::cout<<"Running phtons"<<std::endl;
    ...
    */
    ...
    if(_DoBJets){
      std::cout<<"Running Bjets"<<std::endl;
    ...
    if(_DoVertex){
      std::cout<<"Running HLT vtx"<<std::endl;
    ...
    if(_DoVertex){
      std::cout<<"Running offline vtx"<<std::endl;
