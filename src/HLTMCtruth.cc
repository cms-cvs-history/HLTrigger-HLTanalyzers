...
void HLTMCtruth::analyze(const CandidateCollection& mctruth,
  ...
  if (_Monte) {
	...
	if (((p.pdgId()==11)||(p.pdgId()==-11))&&(p.pt()>2.5)) {el3 += 1;} // Flag for electrons with pT > 2.5 GeV/c
