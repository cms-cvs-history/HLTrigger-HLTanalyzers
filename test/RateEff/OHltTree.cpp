                    ...
                    ) 
{
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	if(L1_TauJet30_ETM30==1) {  // L1 Seed 
      ...
      else if (trignames[it].CompareTo("OpenHLT_L1DoubleMuOpen") == 0) {    
	int rc = 0;
	...
	if(rc > 1) {
      ...
      else if (trignames[it].CompareTo("OpenHLT_IsoMu3") == 0) {   
        if( L1_SingleMu3==1) {      // L1 Seed   
          L1AssHLTBit[it] = true;   
      ...
      else if (trignames[it].CompareTo("OpenHLT_IsoMu9") == 0) {   
        if( L1_SingleMu7==1) {      // L1 Seed   
          L1AssHLTBit[it] = true;   
	...
	if( L1_SingleMu3==1) {      // Old L1 Seed   
      ...
      else if (trignames[it].CompareTo("OpenHLT_L2Mu11") == 0) {           
        if((L1_SingleMu7==1)) {      // L1 Seed           
          L1AssHLTBit[it] = true;          
          int rc = 0; 
          for(int i = 0; i < NohMuL2; i++) { 
      ...
      else if (trignames[it].CompareTo("OpenHLT_L1Mu20") == 0) {         
	int rc = 0;  
	for(int i = 0; i < NL1OpenMu; i++) {  
